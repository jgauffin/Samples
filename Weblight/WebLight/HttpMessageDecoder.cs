...
namespace WebLight
{
    ...
    public class HttpMessageDecoder2 : IMessageDecoder
    {
        ...
        public HttpMessageDecoder2(IMessageSerializer messageSerializer)
        {
        ...
        private void OnRequestLine(string part1, string part2, string part3)
        {
            if (part1.StartsWith("http/", StringComparison.OrdinalIgnoreCase))
            {
                ...
                if (_messageSerializer != null)
                    _message = new HttpResponse((HttpStatusCode)code, part3, part1);
                else
                    _message = new HttpResponseBase((HttpStatusCode)code, part3, part1);
            }
            else
            {
