This namespace represents the Core.Implementation project. 
...
process or server later. (the GUI just got a reference to the Core and not to Core.Implementation).
